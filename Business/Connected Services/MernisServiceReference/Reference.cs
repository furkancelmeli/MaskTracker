...
namespace MernisServiceReference
{
    ...
    public partial class TCKimlikNoDogrulaRequestBody
    {
        ...
        public TCKimlikNoDogrulaRequestBody(string nationalIdentity, string firstName, string firstName1)
        {
        }
        ...
        public TCKimlikNoDogrulaRequestBody(string nationalIdentity, string firstName, string firstName1, int dateOfBirthYear) : this(nationalIdentity, firstName, firstName1)
        {
